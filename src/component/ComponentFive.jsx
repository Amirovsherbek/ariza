           ...
           <div className="home-body-form mt-2 pt-1">
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       ...
                       onChange={(e)=>ChangaData('category5Oq',e.target.value,'','')} />
               ...
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'}
                       onChange={(e)=>ChangaData('category5Zal',e.target.value,'','')} />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'} 
                        onChange={(e)=>ChangaData('category5Mokko',e.target.value,'','')}
                       />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'}
                      onChange={(e)=>ChangaData('category5Mokry',e.target.value,'','')} />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
           </div>
