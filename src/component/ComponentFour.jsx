           ...
           <div className="home-body-form mt-2 pt-1">
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                      ...
                      onChange={(e)=>ChangaData('category4Oq',e.target.value,'','')} />
               ...
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'}
                      onChange={(e)=>ChangaData('category4Zal',e.target.value,'','')} />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'} 
                       onChange={(e)=>ChangaData('category4Mokko',e.target.value,'','')}
                       />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
               <div className="home-body-form-box ">
                   ...
                   <div className="home-body-form-box-2">
                       <input type={'number'} className={'form-control'}
                       onChange={(e)=>ChangaData('category4Mokry',e.target.value,'','')} />
                       <span>{lang.map(item=>item.lang===Lang ? item.price:'')}</span>
                   </div>
               </div>
           </div>
